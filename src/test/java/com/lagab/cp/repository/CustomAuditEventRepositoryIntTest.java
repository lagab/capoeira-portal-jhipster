package com.lagab.cp.repository;

import com.lagab.cp.CpApp;
import com.lagab.cp.config.Constants;
import com.lagab.cp.config.audit.AuditEventConverter;
import com.lagab.cp.domain.PersistentAuditEvent;
...
import static com.lagab.cp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
